...
**Проверенная сборка 1.0.0 (2):** [успешный запуск](https://github.com/lirns200/velora-ios/actions/runs/33979661256) · [скачать артефакт с IPA](https://github.com/lirns200/velora-ios/actions/runs/33979661256/artifacts/9973414620). Для скачивания требуется вход в GitHub; артефакт хранится 14 дней, после истечения срока запусти workflow снова.
