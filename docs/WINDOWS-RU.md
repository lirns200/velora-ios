...
Если сборка красная, скачай **Apple-build-logs** или открой упавший шаг. До первого успешного запуска сборка этого проекта не считается подтверждённой. Созданный workflow не был запущен в исходной Windows-сессии: репозиторий ещё не существовал.
